...
from models.loss import add_losses
...
def create_model(model, data, labels, split):
    ...
    # Edit: Actually this is a misnomer.. should be fc7. Renamed to fc7
    model.Alias(blob_in, 'fc7_beforeAvg')
    ...
    # To have a common handle for logits, needed when training the LSTM
    # Edit: Actually this is a misnomer.. should be fc7. Renamed to fc7
    model.Alias(blob_out, 'fc7')
    ...
    softmax, loss = add_losses(model, split, blob_out, labels)
