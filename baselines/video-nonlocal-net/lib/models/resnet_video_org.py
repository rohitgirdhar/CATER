...
This is the original model architectures used in the paper:
it is for 32-frame input for "short" video and 128-frame for "long"
'''
...
def obtain_arc(arc_type):
    ...
    if arc_type == 1:
        ...
        pool_stride = int(cfg.TRAIN.VIDEO_LENGTH / 8)
